...
public class SigninResponse  implements java.io.Serializable {
    private boolean signinReturn;

    public SigninResponse() {
    }

    public SigninResponse(
           boolean signinReturn) {
     ...
     * @param signinReturn
     */
    public void setSigninReturn(boolean signinReturn) {
        this.signinReturn = signinReturn;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            this.signinReturn == other.isSigninReturn();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        _hashCode += (isSigninReturn() ? Boolean.TRUE : Boolean.FALSE).hashCode();
